			  ...
			  <header id="header" id="home">
		  			...
		  			<div class="container">
				  		<div class="row">
				  			<div class="col-lg-6 col-sm-6 col-4 header-top-left no-padding">
				  				...
				  				<a href="mailto:decorvista@yahoo.com">support@decorvista.com</a>					  
				  			</div>
			    ...
			    <div class="container main-menu">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.html"><img src="dlogo.png" alt="" title="" /></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li class="menu-has-children"><a href="/blogs">Blog</a>
...
<p class="text-center text-muted">&copy; 2025 Decorvista. Inspiring your home with elegance and style.</p>
